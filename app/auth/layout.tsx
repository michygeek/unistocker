...
const AUTH_CSS = `
  ...
  .auth-left {
    ...
    padding: 48px 52px;
    background: linear-gradient(145deg, #0F2030 0%, #1B3D4F 50%, #0F2D20 100%);
    position: relative;
    overflow: hidden;
  }
  ...
  .auth-blob-1 { width: 320px; height: 320px; background: radial-gradient(circle, rgba(46,189,120,0.18) 0%, transparent 70%); top: -80px; right: -80px; }
  .auth-blob-2 { width: 200px; height: 200px; background: radial-gradient(circle, rgba(245,168,35,0.12) 0%, transparent 70%); bottom: 80px; left: -60px; }
  .auth-blob-3 { width: 140px; height: 140px; background: radial-gradient(circle, rgba(46,189,120,0.1) 0%, transparent 70%); bottom: 220px; right: 40px; }
  .auth-dots {
  ...
  .auth-left-headline em       { font-style: normal; color: #2EBD78; }
  .auth-left-headline em.amber { font-style: normal; color: #F5A823; }

  .auth-left-sub { font-size: 15px; color: #5F8F80; line-height: 1.6; margin-bottom: 36px; }

  .auth-feature-list { display: flex; flex-direction: column; gap: 14px; }
  .auth-feature { display: flex; align-items: center; gap: 12px; font-size: 14px; font-weight: 500; color: #A5D4C5; }
  .auth-feature-icon {
    width: 32px; height: 32px; border-radius: 8px; flex-shrink: 0;
    background: rgba(46,189,120,0.15);
  ...
  .auth-stat-lbl { font-size: 11px; color: #4E8A78; margin-top: 2px; }

  .auth-badge-row { display: flex; gap: 8px; flex-wrap: wrap; }
  .auth-badge {
    font-size: 11px; font-weight: 600; padding: 5px 12px; border-radius: 99px;
    border: 1px solid rgba(46,189,120,0.3); color: #4E8A78;
    background: rgba(46,189,120,0.08);
  }

  /* ── Accent strip ─────────────────────────────────── */
  .auth-strip {
    height: 3px;
    background: linear-gradient(90deg, #2EBD78 0%, #F5A823 50%, #1B3D4F 100%);
    flex-shrink: 0;
  }
  ...
  .auth-form-heading {
    font-size: 26px; font-weight: 800; color: #0F2030;
  ...
  .auth-input:focus {
    border-color: #2EBD78; background: #fff;
    box-shadow: 0 0 0 3px rgba(46,189,120,0.12);
  }
  ...
  .auth-btn {
    ...
    background: #2EBD78; color: #fff;
    font-size: 15px; font-weight: 700; border: none; cursor: pointer;
    transition: background 0.15s, transform 0.1s, box-shadow 0.15s;
    letter-spacing: -0.01em; font-family: inherit;
    box-shadow: 0 4px 14px rgba(46,189,120,0.35);
  }
  .auth-btn:hover  { background: #22A865; box-shadow: 0 6px 18px rgba(46,189,120,0.4); }
  .auth-btn:active { transform: scale(0.98); }
  .auth-btn:disabled { background: #86efac; box-shadow: none; cursor: not-allowed; color: #fff; }

  /* ── Navigation links ─────────────────────────────── */
  .auth-bottom-link { text-align: center; margin-top: 22px; font-size: 14px; color: #6b7280; }
  .auth-bottom-link a { color: #2EBD78; font-weight: 600; text-decoration: none; }
  .auth-bottom-link a:hover { color: #22A865; }
  ...
  .auth-forgot {
    ...
    font-size: 13px; color: #2EBD78; font-weight: 600;
    text-decoration: none; margin-top: 6px;
  }
  .auth-forgot:hover { color: #22A865; }
  ...
  .auth-free-badge {
    ...
    background: rgba(46,189,120,0.1); border: 1px solid rgba(46,189,120,0.25);
    color: #22A865; font-size: 11px; font-weight: 700;
  ...
  .auth-registered-icon {
    width: 20px; height: 20px; border-radius: 50%; background: #2EBD78;
    display: flex; align-items: center; justify-content: center;
